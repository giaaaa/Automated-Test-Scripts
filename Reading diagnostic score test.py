...
driver.find_element_by_css_selector('.icon_reading').click()   # select reading
...
expected = {
    0:'1/36',1:'3/36',2:'6/36',3:'8/36',4:'10/36',5:'11/36',6:'12/36',7:'14/36',8:'15/36',9:'16/36',10:'18/36',11:'19/36',
    12:'20/36',13:'22/36',14:'23/36',15:'25/36',16:'27/36',17:'29/36',18:'31/36',19:'34/36',20:'36/36'
    }
...
for number in range(numbers,-1,-1):
    ...
    driver.find_element_by_tag_name('button').click()  # click the Take the test! button
    driver.find_element_by_css_selector('.icon_reading').click()
    score = driver.find_element_by_css_selector('.part-text>span:nth-child(2)').text
    actual[number] = score
    print('Reading: The number of correct answers is %d；The score is %s.' % (number, score))
    driver.find_element_by_tag_name('button').click()    # click the Start/Continue/Retake button
